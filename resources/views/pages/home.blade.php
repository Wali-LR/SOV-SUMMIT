...
<script type="application/ld+json">{!! '{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What does SOV SUMMIT do?", "acceptedAnswer": {"@type": "Answer", "text": "SOV SUMMIT is an international coordination partner for events, executive programmes, and delegations. We connect clients with the right providers across planning, conference production, delegation management, security coordination, media coverage, and travel experiences."}}, {"@type": "Question", "name": "Who does SOV SUMMIT typically work with?", "acceptedAnswer": {"@type": "Answer", "text": "We work with governments, corporations, institutions, associations, and private clients — including executive teams, family offices, event organisers, and production companies. Scope and structure are always adjusted to the client."}}, {"@type": "Question", "name": "What kinds of events do you coordinate?", "acceptedAnswer": {"@type": "Answer", "text": "International conferences, executive dinners, receptions, launches, delegation visits, management training programmes, private journeys, and complex multi-provider engagements. Every programme is scoped individually."}}, {"@type": "Question", "name": "Where does SOV SUMMIT operate?", "acceptedAnswer": {"@type": "Answer", "text": "SOV SUMMIT is the operating brand of Sovereign Summit GmbH, based in Zug, Switzerland, and coordinates programmes internationally through a network of trusted providers in each destination."}}, {"@type": "Question", "name": "How is a project scoped and priced?", "acceptedAnswer": {"@type": "Answer", "text": "Each engagement is quoted individually based on the brief, destination, timing, participants, and services required. After an initial conversation we prepare a tailored proposal outlining scope, providers, and delivery."}}, {"@type": "Question", "name": "How do we start a conversation?", "acceptedAnswer": {"@type": "Answer", "text": "Reach out by email at info@sov-summit.com or via WhatsApp at +41 79 876 35 73. Share a short outline of your programme and we will follow up to discuss requirements and next steps."}}]}' !!}</script>
@endpush
...
<section class="faq" aria-labelledby="faq-heading">
  <div class="container">
    <header class="section-head wide">
      ...
      <p class="lede">A short overview of how SOV SUMMIT works, who we work with, and what to expect from a first conversation.</p>
    </header>

    <div class="faq-list">
      <details class="faq-item">
        <summary>What does SOV SUMMIT do?</summary>
        <p>SOV SUMMIT is an international coordination partner for events, executive programmes, and delegations. We connect clients with the right providers across planning, conference production, delegation management, security coordination, media coverage, and travel experiences.</p>
      </details>

      <details class="faq-item">
        <summary>Who does SOV SUMMIT typically work with?</summary>
        <p>We work with governments, corporations, institutions, associations, and private clients — including executive teams, family offices, event organisers, and production companies. Scope and structure are always adjusted to the client.</p>
      </details>

      <details class="faq-item">
        <summary>What kinds of events do you coordinate?</summary>
        <p>International conferences, executive dinners, receptions, launches, delegation visits, management training programmes, private journeys, and complex multi-provider engagements. Every programme is scoped individually.</p>
      </details>

      <details class="faq-item">
        <summary>Where does SOV SUMMIT operate?</summary>
        <p>SOV SUMMIT is the operating brand of Sovereign Summit GmbH, based in Zug, Switzerland, and coordinates programmes internationally through a network of trusted providers in each destination.</p>
      </details>

      <details class="faq-item">
        <summary>How is a project scoped and priced?</summary>
        <p>Each engagement is quoted individually based on the brief, destination, timing, participants, and services required. After an initial conversation we prepare a tailored proposal outlining scope, providers, and delivery.</p>
      </details>

      <details class="faq-item">
        <summary>How do we start a conversation?</summary>
        <p>Reach out by email at info@sov-summit.com or via WhatsApp at +41 79 876 35 73. Share a short outline of your programme and we will follow up to discuss requirements and next steps.</p>
      </details>
    </div>
  </div>
</section>
